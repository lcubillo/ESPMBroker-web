...
public class EstadisticaDiaAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
			...
			if (idEnvio != null){
				List estadisticaDia = dao.dameResumenDia(idCliente, Integer.parseInt(idEnvio));
				req.setAttribute("estadisticaDia", estadisticaDia);

				List totalesResumenEnvioList = dao.dameTotalesResumenDia(idCliente,Integer.parseInt(idEnvio));
				req.setAttribute("totales",totalesResumenEnvioList);
